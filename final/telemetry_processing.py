...
def fetch_and_process_telemetry_data():
    ...
    try:
        ...
        return backend_status, path_trace_figure, "System State: OK", f"x: {position['x']:.2f}, y: {position['y']:.2f}", f"{heading:.2f}°", f"{battery:.2f}%", f"{ultrasound:.2f} m", {}, {}

    except socket.timeout:
        return "🔴 No telemetry data available", {}, "No data", "N/A", "N/A", "N/A", "N/A", {}, {}