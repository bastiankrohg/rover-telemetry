...
from mjpeg_server import start_mjpeg_server, start_camera_stream  # Import MJPEG server components
        ...
        dbc.Row([
            ...
            dbc.Col(
                html.Div([
                    ...
                    html.Img(
                        src="http://127.0.0.1:8080/",  # MJPEG server URL
...
if __name__ == "__main__":
    ...
    print("You can kill this process later using `kill -9 <PID>` if needed.")
